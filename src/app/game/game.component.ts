...
export class GameComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    ngOnInit(): void {
        ...
        this.loginService.getTeamScore(this.loginService.team_id)
            .valueChanges.subscribe((result: any) => {
                this.gameData=result.data.teamscore;
                console.log(this.gameData);
                this.loginService.nextRound({
                    team_id: this.gameData.team_id,
                    current_round: this.gameData.current_round
                }).subscribe((res: any) => {
                    console.log(res.data);
                    this.round=this.gameData.current_round+1;
                });
            });
